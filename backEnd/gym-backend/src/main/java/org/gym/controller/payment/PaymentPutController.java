...
import org.gym.service.payment.PaymentUpdaterService;
...
public class PaymentPutController {
    private final PaymentUpdaterService paymentUpdaterService;
    ...
    public ResponseEntity<?> update(
        ...
        PaymentResponse response = paymentUpdaterService.update(request, id);
