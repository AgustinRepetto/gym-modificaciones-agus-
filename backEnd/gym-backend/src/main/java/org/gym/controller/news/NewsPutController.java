...
import org.gym.service.news.NewsUpdaterService;
...
public class NewsPutController {
    private final NewsUpdaterService newsUpdaterService;
    ...
    public ResponseEntity<?> update(
        ...
        NewsResponse response = newsUpdaterService.update(id, request);
