...
import org.gym.service.news.NewsCreatorService;
...
public class NewsPostController {
    private final NewsCreatorService newsCreatorService;
    ...
    public ResponseEntity<?> create (
        ...
        NewsResponse response = newsCreatorService.create(newsRequest);
